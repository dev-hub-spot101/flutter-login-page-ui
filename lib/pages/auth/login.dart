              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                  children: <Widget>[
                    ...
                    SizedBox(height: 6),
                    Text("Login UI", style: TextStyle(color: Colors.pinkAccent, fontSize: 40, fontFamily:'BalooPaaji2', fontWeight: FontWeight.w600)),
                  ],
                ),
                Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Text("Sign in", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 40)),
                    SizedBox(height: 16,),
                    TextFormField(
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            icon: Icon(
                              _isObscure ? Icons.visibility : Icons.visibility_off, color: Colors.grey,size: 18,
                            ),
                            onPressed: () {
                              setState(() {
                              ...
                              Container(
                                ...
                                child: CircleAvatar(
                                  ...
                                  child: IconButton(
                                    icon: _isLoading?
                                        Container(
                                          width: 24, height: 24,padding: EdgeInsets.all(2.0),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Text("DevhubSpot", style: TextStyle(color: Colors.pinkAccent, fontWeight: FontWeight.bold)),
                      )
                    ],
                  ),
                )
